...
urlpatterns = [
    ...
    path('colecoes-home/', views.home_collection_list, name='home_collections'),
    path('colecoes-home/nova/', views.home_collection_edit, name='home_collection_add'),
    path('colecoes-home/<int:pk>/editar/', views.home_collection_edit, name='home_collection_edit'),
