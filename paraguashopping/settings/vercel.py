...
if _database_url:
    ...
    _preview_runtime_db = Path(config('VERCEL_PREVIEW_RUNTIME_DB', default='/tmp/essencek_preview.sqlite3'))  # nosec B108
...
_preview_runtime_media = Path(config('VERCEL_PREVIEW_RUNTIME_MEDIA', default='/tmp/essencek_media'))  # nosec B108
